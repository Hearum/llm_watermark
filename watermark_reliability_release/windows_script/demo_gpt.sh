...
if [ -z "$1" ]; then
    ...
    PATH_DIR="/home/shenhm/documents/lm-watermarking/watermark_reliability_release/output/delta2_len_100/llama_7B_N500_T200_no_filter_batch_1_delta_5_gamma_0.25_LshParm_5_32_0.2_LSH_v2.2_c4_new"
else
    PATH_DIR="$1"
